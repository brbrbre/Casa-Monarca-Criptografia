...
def _canonical_payload(registration) -> bytes:
    data = {
        ...
        'first_surname': registration.first_surname,
        'second_surname': registration.second_surname,
        'birth_date': str(registration.birth_date),
        'gender': registration.gender,
        'country_of_origin': registration.country_of_origin,
        'phone': registration.phone,
        'service_date': str(registration.service_date),
        'state_or_region': registration.state_or_region,
        'marital_status': registration.marital_status,
        'age_group': registration.age_group,
        'population_group': registration.population_group,
