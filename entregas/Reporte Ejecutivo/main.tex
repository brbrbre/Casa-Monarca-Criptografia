...
Casa Monarca brinda apoyo humanitario, legal y psicosocial a personas migrantes en situación vulnerable. Dado que maneja información muy sensible (datos personales, documentos legales y expedientes de beneficiarios) es fundamental garantizar que esa información esté protegida, sea confiable y deje rastro de quién la consulta o modifica.
Para atender esta necesidad, se desarrolló un sistema digital con dos funciones principales. La primera es la gestión de colaboradores: permite registrar altas y bajas de colaboradores, asignarles un nivel de acceso según su rol, y llevar un historial completo de toda actividad dentro del sistema. La segunda es el registro de migrantes: los datos sensibles de cada persona quedan resguardados desde el momento en que se capturan, y cualquier acción sobre un expediente debe ser aprobada por el nivel jerárquico correspondiente (1-4). Además, el sistema permite que los migrantes ejerzan su derechos ARCO, con recordatorios automáticos de los plazos legales que la organización debe cumplir.
El sistema fue construido sobre la misma infraestructura tecnológica que Casa Monarca ya utiliza, por lo que no representa ningún costo adicional de instalación ni de mantenimiento.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{flujo_casa_monarca_ejecutivo.png}
\caption{Diagrama de flujo Generado con Claude (Anthropic, 2026).}
\end{figure}

La figura 1 muestra quién usa el sistema y qué acciones puede realizar dependiendo de su nivel. 
...
\midrule
Hosting alternativo (promedio Bluehost / Hostinger / SiteGround) & \textasciitilde\$130 USD \\
Autoridad certificadora externa — Sectigo OV (referencia)        & \textasciitilde\$37 USD \\
\textbf{Total solución externa}                                   & \textbf{\textasciitilde\$167 USD} \\
Nuestro sistema (HostGator + CA propia)                          & \textasciitilde\$100 USD \\
\textbf{Ahorro anual}                                            & \textbf{\textasciitilde\$67 USD} \\
\bottomrule
\end{tabularx}
\caption{Comparación de costos anuales entre el sistema desarrollado y alternativas comerciales equivalentes.}
\end{table}
...
\item Hostinger. (2026). \textit{Hosting web}. Disponible en: \url{https://www.hostinger.com/mx}
